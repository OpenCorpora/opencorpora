...
<div class="span4 ner-table-wrap">
  <div class="tabbable dragged-upper">
    <ul class="nav nav-tabs small-tabs">
      <li class="active"><a href="#tab-entities-{$his_user_id}-{$paragraph.id}" data-toggle="tab">Спаны</a></li>
      <li><a href="#tab-mentions-{$his_user_id}-{$paragraph.id}" data-toggle="tab" class="tab-opener">Упоминания</a></li>
    </ul>
    <div class="tab-content">
      <div class="tab-pane active" id="tab-entities-{$his_user_id}-{$paragraph.id}">
        ...
        {foreach $his_paragraph.named_entities as $ne}
          <tr data-entity-id="{$ne.id}">
            <td class="ner-entity-actions"><i class="icon icon-magnet ner-copy copy-ner" data-entity-id={$ne.id}></i></td>
      ...
      {foreach $his_paragraph.mentions as $id => $mention}
        ...
        <tr data-mention-id="{$id}">
          <td class="ner-mention-actions"><i class="icon icon-magnet ner-copy copy-mention" data-mention-id={$id}></i></td>
