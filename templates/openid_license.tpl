...
<form action="?act=login_openid2" method="post">
    <label class="checkbox"><input type='checkbox' name='agree' value='1' onclick="$('#reg_button').attr('disabled', !$(this).is(':checked'))"/> Я согласен на неотзывную публикацию всех вносимых мной изменений в соответствии с лицензией <a href="http://creativecommons.org/licenses/by-sa/3.0/deed.ru" target="_blank">Creative Commons Attribution/Share-Alike 3.0</a></label>
