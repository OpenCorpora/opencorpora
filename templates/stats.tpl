...
<tr>
    ...
    <td>
        <b>{$stats.chaskor_words.value}</b> <span class='small'>({$stats.chaskor_words.timestamp|date_format:"%d.%m.%y, %H:%M"})</span><br/>
        <table border='0'><tr><td>
        <div class="progress"><div class="progress_load" style="width: {$stats.percent_words.chaskor}px"></div></div>
        </td><td><span class='hint' title='Цель до конца 2011 года &ndash; {$goals.chaskor_words}'>{$stats.percent_words.chaskor}%</span></td>
        </table>
    </td>
</tr>
<tr>
    ...
    <td>
        <b>{$stats.wikipedia_words.value}</b> <span class='small'>({$stats.wikipedia_words.timestamp|date_format:"%d.%m.%y, %H:%M"})</span><br/>
        <table border='0'><tr><td>
        <div class="progress"><div class="progress_load" style="width: {$stats.percent_words.wikipedia}px"></div></div>
        </td><td><span class='hint' title='Цель до конца 2011 года &ndash; {$goals.wikipedia_words}'>{$stats.percent_words.wikipedia}%</span></td>
        </table>
    </td>
</tr>
<tr>
    ...
    <td>
        <b>{$stats.wikinews_words.value}</b> <span class='small'>({$stats.wikinews_words.timestamp|date_format:"%d.%m.%y, %H:%M"})</span><br/>
        <table border='0'><tr><td>
        <div class="progress"><div class="progress_load" style="width: {$stats.percent_words.wikinews}px"></div></div>
        </td><td><span class='hint' title='Цель до конца 2011 года &ndash; {$goals.wikinews_words}'>{$stats.percent_words.wikinews}%</span></td>
        </table>
    </td>
</tr>
<tr>
    ...
    <td>
        ...
        <table border='0'><tr><td>
        <div class="progress"><div class="progress_load" style="width: {$stats.percent_words.total}px"></div></div>
        </td><td><span class='hint' title='Цель до конца 2011 года &ndash; {$goals.total_words}'>{$stats.percent_words.total}%</span></td>
        </table>
    </td>
</tr>
</table>
