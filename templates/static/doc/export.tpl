...
<h2>Формат экспорта словаря (версия 0.8)</h2>
<p>Словарь представляет собой файл XML в кодировке utf-8.</p>
<p>Всё содержимое обёрнуто в корневой тег <code>&lt;dictionary&gt;</code>, атрибуты которого указывают на версию формата (сейчас 0.8) и номер ревизии словаря на момент экспорта. Внутри выделяются 4 секции, описывающие граммемы, собственно леммы, типы связей между ними и сами связи.</p>
