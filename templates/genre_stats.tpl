...
<tr>
    ...
    <td>
        <p><b>{$stats.chaskor_words.value|number_format:0:'':' '}</b> = <span class='hint' title='Текущая цель &ndash; {$goals.chaskor_words}'>{$stats.percent_words.chaskor}%</span></p>
...
<tr>
    ...
    <td>
        <p><b>{$stats.chaskor_news_words.value|number_format:0:'':' '}</b> = <span class='hint' title='Текущая цель &ndash; {$goals.chaskor_news_words}'>{$stats.percent_words.chaskor_news}%</span></p>
...
<tr>
    ...
    <td>
        <p><b>{$stats.wikipedia_words.value|number_format:0:'':' '}</b> =  <span class='hint' title='Текущая цель &ndash; {$goals.wikipedia_words}'>{$stats.percent_words.wikipedia}%</span></p>
...
<tr>
    ...
    <td>
        <p><b>{$stats.wikinews_words.value|number_format:0:'':' '}</b> =  <span class='hint' title='Текущая цель &ndash; {$goals.wikinews_words}'>{$stats.percent_words.wikinews}%</span></p>
...
<tr>
    ...
    <td>
        <p><b>{$stats.blogs_words.value|number_format:0:'':' '}</b> = <span class='hint' title='Текущая цель &ndash; {$goals.blogs_words}'>{$stats.percent_words.blogs}%</span></p>
...
<tr>
    ...
    <td>
        <p><b>{$stats.fiction_words.value|number_format:0:'':' '}</b> = <span class='hint' title='Текущая цель &ndash; {$goals.fiction_words}'>{$stats.percent_words.fiction}%</span></p>
...
<tr>
    ...
    <td>
        <p><b>{$stats.nonfiction_words.value|number_format:0:'':' '}</b> = <span class='hint' title='Текущая цель &ndash; {$goals.nonfiction_words}'>{$stats.percent_words.nonfiction}%</span></p>
...
<tr>
    ...
    <td>
        <p><b>{$stats.law_words.value|number_format:0:'':' '}</b> = <span class='hint' title='Текущая цель &ndash; {$goals.law_words}'>{$stats.percent_words.law}%</span></p>
...
<tr>
    ...
    <td>
        <p><b>{$stats.misc_words.value|number_format:0:'':' '}</b> = <span class='hint' title='Текущая цель &ndash; {$goals.misc_words}'>{$stats.percent_words.misc}%</span></p>
...
<tr>
    ...
    <td>
        <p><b>{$stats.total_words.value|number_format:0:'':' '}</b> = <span class='hint' title='Текущая цель &ndash; {$goals.total_words}'>{$stats.percent_words.total}%</span></p>
