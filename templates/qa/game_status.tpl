<div class="container" style="position:relative;">
    <div class="ma_status_block">
        ...
        <div class="badges-block pull-left">
            <a href="#" title="Бейдж пока вам недоступен" class="badge-inactive"><img src="img/icon_speed_60.png"></a>
            <a href="#"><img class="img-circle" src="img/icon_glass.png"></a>
            <a href="#"><img class="img-circle" src="img/icon_plus.png"></a>
        </div>
    </div>
</div>
