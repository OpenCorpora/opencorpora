...
<label><input type='radio' name='type' value='all' checked='checked'/>все примеры</label><br/>
<input type='radio' name='type' value='random'/><input name='random_n' maxlength='4' size='4' value='100'/> случайных<br/>
