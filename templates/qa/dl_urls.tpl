...
<tr{if !$obj.filename || !$obj.exists} class="error"{/if}>
    <td><a href="/books.php?book_id={$obj.book_id}">{$obj.book_name|htmlspecialchars}</a></td>
    <td><a href="{$obj.url}">{$obj.url|truncate}</a></td>
    <td><a href="/files/saved/{$obj.filename}.html">{$obj.filename}</a>{if $obj.filename && !$obj.exists}, не существует{/if}</td>
</tr>
{/foreach}
</table>
{/block}
