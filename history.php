...
while ($r = sql_fetch_array($res)) {
    printf ("<tr><td>%d<td>%s<td>%s<td><a href=\"sentence.php?id=%d\">Предложение %d</a><td><a href=\"diff.php?sent_id=%d&set_id=%d\">Изменения</a></tr>", $r['set_id'], $r['user_id']?$r['user_name']:'Робот', strftime("%a %d.%m.%Y, %H:%I", $r['timestamp']), $r['sent_id'], $r['sent_id'], $r['sent_id'], $r['set_id']);
}
print "</table>";
?>
</div>
