...
$importer->preload_list('adjf_fixd_del', '/home/grand/corpus/scripts/lists/list_adjf_fixd_delete.txt');
$importer->preload_list('adjf_fixd_advb', '/home/grand/corpus/scripts/lists/list_adjf_fixd_ADVB.txt');
