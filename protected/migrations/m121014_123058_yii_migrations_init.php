...
class m121014_123058_yii_migrations_init extends CDbMigration
{
    /*public function up()
    {
    }
    ...
    {
            echo "m121014_123058_yii_migrations_init does not support migration down.\n";
            return false;
    }
    */
...
CREATE TABLE IF NOT EXISTS `user_rating_log` (
    `user_id`   SMALLINT UNSIGNED NOT NULL,
...
INSERT INTO `stats_param` VALUES
    ...
    (35, 'total_parses', 1),
    (36, 'unknown_words', 1),
    (37, 'unambiguous_parses', 1),
    (38, 'annotators_moderated', 1),
    (39, 'annotators_correct', 1);
...
SQL
    ...
    public function safeDown() {
        ...
        $this->dropTable("sources_comments");
        $this->dropTable("sources_status");
        $this->dropTable("morph_annot_pool_types");
        $this->dropTable("morph_annot_pools");
        $this->dropTable("morph_annot_candidate_samples");
        $this->dropTable("morph_annot_samples");
        $this->dropTable("morph_annot_moderated_samples");
        $this->dropTable("morph_annot_instances");
        $this->dropTable("morph_annot_rejected_samples");
        $this->dropTable("morph_annot_comments");
        $this->dropTable("morph_annot_click_log");
        $this->dropTable("downloaded_urls");
        $this->dropTable("paragraphs");
        $this->dropTable("sentences");
        $this->dropTable("sentence_check");
        $this->dropTable("sentence_comments");
        $this->dropTable("sentence_authors");
        $this->dropTable("text_forms");
        $this->dropTable("users");
        $this->dropTable("user_aliases");
        $this->dropTable("user_permissions");
        $this->dropTable("user_options_values");
        $this->dropTable("user_options");
        $this->dropTable("user_stats");
        $this->dropTable("user_teams");
        $this->dropTable("user_tokens");
        $this->dropTable("user_rating_log");
        $this->dropTable("user_badges_types");
        $this->dropTable("user_badges");
        $this->dropTable("tf_revisions");
        $this->dropTable("rev_sets");
        $this->dropTable("dict_lemmata");
        $this->dropTable("dict_lemmata_deleted");
        $this->dropTable("dict_links_types");
        $this->dropTable("dict_links");
        $this->dropTable("dict_links_revisions");
        $this->dropTable("dict_lex");
        $this->dropTable("dict_revisions");
        $this->dropTable("dict_errata");
        $this->dropTable("dict_errata_exceptions");
        $this->dropTable("updated_forms");
        $this->dropTable("form2lemma");
        $this->dropTable("form2tf");
        $this->dropTable("gram");
        $this->dropTable("gram_restrictions");
        $this->dropTable("stats_param");
        $this->dropTable("stats_values");
        $this->dropTable("tag_stats");
        $this->dropTable("tokenizer_coeff");
        $this->dropTable("tokenizer_strange");
        $this->dropTable("sentences_strange");
