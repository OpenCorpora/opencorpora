...
$config['msg_notadmin'] = 'У вас недостаточно прав для просмотра этой страницы.';
$config['msg_notlogged'] = 'Для просмотра этой страницы необходимо войти под своим именем и паролем.';
?>
